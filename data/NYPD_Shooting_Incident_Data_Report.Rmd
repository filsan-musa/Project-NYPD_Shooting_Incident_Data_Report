...
<table border="1" style="border-collapse: collapse; width: 100%;">
  <caption>Data dictionary for NYPD Shooting Incident Dataset (Historic)</caption>
  <thead>
    <tr>
      <th>Variable</th>
      <th>Description</th>
...
ggplot(data, aes(x = BORO)) +
  ...
  labs(
       title = "Murder vs Non-Murder by Borough",
       x = "Borough",
       y = "Count",
...
nyc_shoot <- nyc_shoot %>% rename(
    ...
    LONGITUDE = Longitude)
```
Note: Renaming to match original `UPPER_SNAKE_CASE` used for the majority of variable names.
